        ...
        options: {
            storySort: {
                order: [
                    ...
                    'Getting Started',
                    'Apis', [
                        'Features', ['Columns Definition', 'Filtering', 'Sorting', 'Paging', 'Sticky Header', 'Footer', 'Row Detail', 'Row Actions', 'Confirm Modal', 'Row Selection', 'Row Highlighting', 'Custom Cell Renders', 'Column Pinning'],
                        'Components', [
                            'Table',
